...
interface Props {
  ...
  /** Halaman mana yang diberi tekstur kertas. Bawaan: semua halaman setelah sampul dan lilin. */
  textured?: (i: number) => boolean;
}
...
export function PageTurner({ children, index, onChange, canAdvance, textured = (i) => i >= 2 }: Props) {
        ...
        {children.map((child, i) => {
          ...
          return (
            ...
            >
              ...
              {textured(i) && <div className="bk-paperfx" aria-hidden="true" />}
